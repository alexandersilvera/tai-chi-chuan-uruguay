 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wr="[DEFAULT]",Oc={[Qr]:"fire-core",[uc]:"fire-core-compat",[cc]:"fire-analytics",[lc]:"fire-analytics-compat",[dc]:"fire-app-check",[hc]:"fire-app-check-compat",[fc]:"fire-auth",[mc]:"fire-auth-compat",[pc]:"fire-rtdb",[gc]:"fire-data-connect",[_c]:"fire-rtdb-compat",[yc]:"fire-fn",[Ec]:"fire-fn-compat",[vc]:"fire-iid",[Tc]:"fire-iid-compat",[Ic]:"fire-fcm",[wc]:"fire-fcm-compat",[Ac]:"fire-perf",[Rc]:"fire-perf-compat",[Cc]:"fire-rc",[Sc]:"fire-rc-compat",[Pc]:"fire-gcs",[bc]:"fire-gcs-compat",[Vc]:"fire-fst",[kc]:"fire-fst-compat",[Dc]:"fire-vertex","fire-js":"fire-js",[Nc]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Aa{constructor(t,e){this.user=e,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${t}`)}}class Ra{getToken(){return Promise.resolve(null)}invalidateToken(){}start(t,e){t.enqueueRetryable(()=>e(pt.UNAUTHENTICATED))}shutdown(){}}class Yc{constructor(t){this.token=t,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(t,e){this.changeListener=e,t.enqueueRetryable(()=>e(this.token.user))}shutdown(){this.changeListener=null}}class Zc{constructor(t){this.t=t,this.currentUser=pt.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(t,e){W(this.o===void 0);let r=this.i;const i=d=>this.i!==r?(r=this.i,e(d)):Promise.resolve();let o=new se;this.o=()=>{this.i++,this.currentUser=this.u(),o.resolve(),o=new se,t.enqueueRetryable(()=>i(this.currentUser))};const u=()=>{const d=o;t.enqueueRetryable(async()=>{await d.promise,await i(this.currentUser)})},c=d=>{V("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=d,this.o&&(this.auth.addAuthTokenListener(this.o),u())};this.t.onInit(d=>c(d)),setTimeout(()=>{if(!this.auth){const d=this.t.getImmediate({optional:!0});d?c(d):(V("FirebaseAuthCredentialsProvider","Auth not yet detected"),o.resolve(),o=new se)}},0),u()}getToken(){const t=this.i,e=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(e).then(r=>this.i!==t?(V("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(W(typeof r.accessToken=="string"),new Aa(r.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const t=this.auth&&this.auth.getUid();return W(t===null||typeof t=="string"),new pt(t)}}class th{constructor(t,e,r){this.l=t,this.h=e,this.P=r,this.type="FirstParty",this.user=pt.FIRST_PARTY,this.T=new Map}I(){return this.P?this.P():null}get headers(){this.T.set("X-Goog-AuthUser",this.l);const t=this.I();return t&&this.T.set("Authorization",t),this.h&&this.T.set("X-Goog-Iam-Authorization-Token",this.h),this.T}}class eh{constructor(t,e,r){this.l=t,this.h=e,this.P=r}getToken(){return Promise.resolve(new th(this.l,this.h,this.P))}start(t,e){t.enqueueRetryable(()=>e(pt.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class io{constructor(t){this.value=t,this.type="AppCheck",this.headers=new Map,t&&t.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class nh{constructor(t,e){this.A=e,this.forceRefresh=!1,this.appCheck=null,this.R=null,this.V=null,fa(t)&&t.settings.appCheckToken&&(this.V=t.settings.appCheckToken)}start(t,e){W(this.o===void 0);const r=o=>{o.error!=null&&V("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${o.error.message}`);const u=o.token!==this.R;return this.R=o.token,V("FirebaseAppCheckTokenProvider",`Received ${u?"new":"existing"} token.`),u?e(o.token):Promise.resolve()};this.o=o=>{t.enqueueRetryable(()=>r(o))};const i=o=>{V("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=o,this.o&&this.appCheck.addTokenListener(this.o)};this.A.onInit(o=>i(o)),setTimeout(()=>{if(!this.appCheck){const o=this.A.getImmediate({optional:!0});o?i(o):V("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){if(this.V)return Promise.resolve(new io(this.V));const t=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(t).then(e=>e?(W(typeof e.token=="string"),this.R=e.token,new io(e.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sa="";function fh(n){let t="";for(let e=0;e<n.length;e++)t.length>0&&(t=co(t)),t=mh(n.get(e),t);return co(t)}function mh(n,t){let e=t;const r=n.length;for(let i=0;i<r;i++){const o=n.charAt(i);switch(o){case"\0":e+="";break;case Sa:e+="";break;default:e+=o}}return e}function co(n){return n+Sa+""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ho(n){let t=0;for(const e in n)Object.prototype.hasOwnProperty.call(n,e)&&t++;return t}function cn(n,t){for(const e in n)Object.prototype.hasOwnProperty.call(n,e)&&t(e,n[e])}function ph(n){for(const t in n)if(Object.prototype.hasOwnProperty.call(n,t))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ud{constructor(){this.Zi=!1,this.Xi=!1,this.es=100,this.ts=function(){return Ol()?8:hh(Nl())>0?6:4}()}initialize(t,e){this.ns=t,this.indexManager=e,this.Zi=!0}getDocumentsMatchingQuery(t,e,r,i){const o={result:null};return this.rs(t,e).next(u=>{o.result=u}).next(()=>{if(!o.result)return this.ss(t,e,i,r).next(u=>{o.result=u})}).next(()=>{if(o.result)return;const u=new Fd;return this._s(t,e,u).next(c=>{if(o.result=c,this.Xi)return this.us(t,e,u,c.size)})}).next(()=>o.result)}us(t,e,r,i){return r.documentReadCount<this.es?(me()<=B.DEBUG&&V("QueryEngine","SDK will not create cache indexes for query:",pe(e),"since it only creates cache indexes for collection contains","more than or equal to",this.es,"documents"),R.resolve()):(me()<=B.DEBUG&&V("QueryEngine","Query:",pe(e),"scans",r.documentReadCount,"local documents and returns",i,"documents as results."),r.documentReadCount>this.ts*i?(me()<=B.DEBUG&&V("QueryEngine","The SDK decides to create cache indexes for query:",pe(e),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(t,Ct(e))):R.resolve())}rs(t,e){if(To(e))return R.resolve(null);let r=Ct(e);return this.indexManager.getIndexType(t,r).next(i=>i===0?null:(e.limit!==null&&i===1&&(e=is(e,null,"F"),r=Ct(e)),this.indexManager.getDocumentsMatchingTarget(t,r).next(o=>{const u=j(...o);return this.ns.getDocuments(t,u).next(c=>this.indexManager.getMinOffset(t,r).next(d=>{const f=this.cs(e,c);return this.ls(e,f,u,d.readTime)?this.rs(t,is(e,null,"F")):this.hs(t,f,e,d)}))})))}ss(t,e,r,i){return To(e)||i.isEqual(L.min())?R.resolve(null):this.ns.getDocuments(t,r).next(o=>{const u=this.cs(e,o);return this.ls(e,u,r,i)?R.resolve(null):(me()<=B.DEBUG&&V("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),pe(e)),this.hs(t,u,e,oh(i,on)).next(c=>c))})}cs(t,e){let r=new nt(Ba(t));return e.forEach((i,o)=>{or(t,o)&&(r=r.add(o))}),r}ls(t,e,r,i){if(t.limit===null)return!1;if(r.size!==e.size)return!0;const o=t.limitType==="F"?e.last():e.first();return!!o&&(o.hasPendingWrites||o.version.compareTo(i)>0)}_s(t,e,r){return me()<=B.DEBUG&&V("QueryEngine","Using full collection scan to execute query:",pe(e)),this.ns.getDocumentsMatchingQuery(t,e,Kt.min(),r)}hs(t,e,r,i){return this.ns.getDocumentsMatchingQuery(t,r,i).next(o=>(e.forEach(u=>{o=o.insert(u.key,u)}),o))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mt="WebChannelConnection";class Yd extends Xd{constructor(t){super(t),this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}vo(t,e,r,i){const o=hs();return new Promise((u,c)=>{const d=new Ea;d.setWithCredentials(!0),d.listenOnce(va.COMPLETE,()=>{try{switch(d.getLastErrorCode()){case Un.NO_ERROR:const _=d.getResponseJson();V(mt,`XHR for RPC '${t}' ${o} received:`,JSON.stringify(_)),u(_);break;case Un.TIMEOUT:V(mt,`RPC '${t}' ${o} timed out`),c(new N(b.DEADLINE_EXCEEDED,"Request time out"));break;case Un.HTTP_ERROR:const w=d.getStatus();if(V(mt,`RPC '${t}' ${o} failed with status:`,w,"response text:",d.getResponseText()),w>0){let C=d.getResponseJson();Array.isArray(C)&&(C=C[0]);const S=C?.error;if(S&&S.status&&S.message){const D=function(k){const Q=k.toLowerCase().replace(/_/g,"-");return Object.values(b).indexOf(Q)>=0?Q:b.UNKNOWN}(S.status);c(new N(D,S.message))}else c(new N(b.UNKNOWN,"Server responded with status "+d.getStatus()))}else c(new N(b.UNAVAILABLE,"Connection failed."));break;default:M()}}finally{V(mt,`RPC '${t}' ${o} completed.`)}});const f=JSON.stringify(i);V(mt,`RPC '${t}' ${o} sending request:`,i),d.send(e,"POST",f,r,15)})}Wo(t,e,r){const i=hs(),o=[this.po,"/","google.firestore.v1.Firestore","/",t,"/channel"],u=wa(),c=Ia(),d={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},f=this.longPollingOptions.timeoutSeconds;f!==void 0&&(d.longPollingTimeout=Math.round(1e3*f)),this.useFetchStreams&&(d.useFetchStreams=!0),this.Do(d.initMessageHeaders,e,r),d.encodeInitMessageHeaders=!0;const _=o.join("");V(mt,`Creating RPC '${t}' stream ${i}: ${_}`,d);const w=u.createWebChannel(_,d);let C=!1,S=!1;const D=new Jd({Fo:k=>{S?V(mt,`Not sending because RPC '${t}' stream ${i} is closed:`,k):(C||(V(mt,`Opening RPC '${t}' stream ${i} transport.`),w.open(),C=!0),V(mt,`RPC '${t}' stream ${i} sending:`,k),w.send(k))},Mo:()=>w.close()}),O=(k,Q,z)=>{k.listen(Q,K=>{try{z(K)}catch(rt){setTimeout(()=>{throw rt},0)}})};return O(w,Xe.EventType.OPEN,()=>{S||(V(mt,`RPC '${t}' stream ${i} transport opened.`),D.Qo())}),O(w,Xe.EventType.CLOSE,()=>{S||(S=!0,V(mt,`RPC '${t}' stream ${i} transport closed`),D.Uo())}),O(w,Xe.EventType.ERROR,k=>{S||(S=!0,ae(mt,`RPC '${t}' stream ${i} transport errored:`,k),D.Uo(new N(b.UNAVAILABLE,"The operation could not be completed")))}),O(w,Xe.EventType.MESSAGE,k=>{var Q;if(!S){const z=k.data[0];W(!!z);const K=z,rt=K?.error||((Q=K[0])===null||Q===void 0?void 0:Q.error);if(rt){V(mt,`RPC '${t}' stream ${i} received error:`,rt);const Vt=rt.status;let ot=function(g){const y=tt[g];if(y!==void 0)return Qa(y)}(Vt),v=rt.message;ot===void 0&&(ot=b.INTERNAL,v="Unknown error status: "+Vt+" with message "+rt.message),S=!0,D.Uo(new N(ot,v)),w.close()}else V(mt,`RPC '${t}' stream ${i} received:`,z),D.Ko(z)}}),O(c,Ta.STAT_EVENT,k=>{k.stat===Jr.PROXY?V(mt,`RPC '${t}' stream ${i} detected buffering proxy`):k.stat===Jr.NOPROXY&&V(mt,`RPC '${t}' stream ${i} detected no buffering proxy`)}),setTimeout(()=>{D.$o()},0),D}}function qr(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ps="us-central1";class Wf{constructor(t,e,r,i,o=ps,u=(...c)=>fetch(...c)){this.app=t,this.fetchImpl=u,this.emulatorOrigin=null,this.contextProvider=new Qf(t,e,r,i),this.cancelAllRequests=new Promise(c=>{this.deleteService=()=>Promise.resolve(c())});try{const c=new URL(o);this.customDomain=c.origin+(c.pathname==="/"?"":c.pathname),this.region=ps}catch{this.customDomain=null,this.region=o}}_delete(){return this.deleteService()}_url(t){const e=this.app.options.projectId;return this.emulatorOrigin!==null?`${this.emulatorOrigin}/${e}/${this.region}/${t}`:this.customDomain!==null?`${this.customDomain}/${t}`:`https://${this.region}-${e}.cloudfunctions.net/${t}`}}function Xf(n,t,e){n.emulatorOrigin=`http://${t}:${e}`}const ta="@firebase/functions",ea="0.12.3";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function em(n=pa(),t=ps){const r=da(_s(n),xu).getImmediate({identifier:t}),i=oa("functions");return i&&Ou(r,...i),r}function Ou(n,t,e){Xf(_s(n),t,e)}tm();const nm={apiKey:"AIzaSyDJCw6SF-NJIcfa3HNBc4kGA-1uSZTh0Hw",authDomain:"reino-da-mata-160a9.firebaseapp.com",projectId:"reino-da-mata-160a9",storageBucket:"reino-da-mata-160a9.appspot.com",messagingSenderId:"345009196252",appId:"1:345009196252:web:c6e50079b36005b4a7b819"},Lu=ma(nm),Mu=Au(Lu);let rm=em(Lu,"us-central1");typeof window<"u"&&window.location.hostname==="localhost"&&((async()=>{const{connectFirestoreEmulator:n}=await ra(async()=>{const{connectFirestoreEmulator:t}=await Promise.resolve().then(()=>Nu);return{connectFirestoreEmulator:t}},void 0);n(Mu,"localhost",8080)})(),Ou(rm,"localhost",5001));const ut=[];for(let n=0;n<256;++n)ut.push((n+256).toString(16).slice(1));function sm(n,t=0){return(ut[n[t+0]]+ut[n[t+1]]+ut[n[t+2]]+ut[n[t+3]]+"-"+ut[n[t+4]]+ut[n[t+5]]+"-"+ut[n[t+6]]+ut[n[t+7]]+"-"+ut[n[t+8]]+ut[n[t+9]]+"-"+ut[n[t+10]]+ut[n[t+11]]+ut[n[t+12]]+ut[n[t+13]]+ut[n[t+14]]+ut[n[t+15]]).toLowerCase()}let Hr;const im=new Uint8Array(16);function om(){if(!Hr){if(typeof crypto>"u"||!crypto.getRandomValues)throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");Hr=crypto.getRandomValues.bind(crypto)}return Hr(im)}const am=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),na={randomUUID:am};function um(n,t,e){if(na.randomUUID&&!n)return na.randomUUID();n=n||{};const r=n.random??n.rng?.()??om();if(r.length<16)throw new Error("Random bytes length must be >= 16");return r[6]=r[6]&15|64,r[8]=r[8]&63|128,sm(r)}const lm=async({slug:n,userId:t})=>{try{return await(await fetch("https://handlelike-3hjph2wfea-uc.a.run.app",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({slug:n,userId:t}),credentials:"omit"})).json()}catch(e){return{success:!1,message:e.message||"Error de red o formato de respuesta"}}};function fm({slug:n,initialLikes:t}){console.log("[LikeButton] RENDER - slug:",n,"initialLikes:",t);const[e,r]=fe.useState(t),[i,o]=fe.useState(!1),[u,c]=fe.useState(""),[d,f]=fe.useState(null),[_,w]=fe.useState(!1);fe.useEffect(()=>{if(typeof window<"u"){let D=localStorage.getItem("userId");D||(D=um(),localStorage.setItem("userId",D)),f(D),w(localStorage.getItem(`liked-${n}-${D}`)==="true")}async function S(){if(n)try{const{doc:D,getDoc:O}=await ra(async()=>{const{doc:z,getDoc:K}=await Promise.resolve().then(()=>Nu);return{doc:z,getDoc:K}},void 0),k=D(Mu,"likes",n),Q=await O(k);if(Q.exists()){const z=Q.data();r(z.count||0)}}catch(D){console.error("Error consultando likes en Firestore:",D)}}S()},[n]);const C=async()=>{if(console.log("[LikeButton] handleLike - slug:",n,"userId:",d),!n){console.error("Intentando dar like sin slug disponible."),c("No se pudo identificar el artículo.");return}if(!d){console.error("Intentando dar like sin userId disponible."),c("Espera un momento e inténtalo de nuevo.");return}o(!0),c("");try{console.log("[LikeButton] handleLike - Calling function with:",{slug:n,userId:d});const S=await lm({slug:n,userId:d});console.log("[LikeButton] handleLike - Function result:",S),S&&S.success?(r(S.newLikes),typeof window<"u"&&(localStorage.setItem(`liked-${n}-${d}`,"true"),w(!0))):c(S?.message||"Error al dar like")}catch(S){console.error("Error calling handleLike function:",S),c(S.message||"Ocurrió un error")}finally{o(!1)}};return Nn.jsxs("div",{children:[Nn.jsxs("button",{className:`px-4 py-2 rounded font-semibold transition-colors duration-200 flex items-center gap-2 ${_?"bg-emerald-700 text-emerald-100 cursor-not-allowed":"bg-zinc-800 text-zinc-300 hover:bg-emerald-600 hover:text-white"} ${i?"opacity-50 cursor-wait":""}`,onClick:C,disabled:i||_,"aria-label":_?"Ya diste like":"Dar like",children:[Nn.jsx("span",{className:"icon",children:"❤️"})," ",e]}),u&&Nn.jsx("div",{className:"error",children:u})]})}export{fm as default};
